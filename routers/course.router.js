...
import { authValidUserCheck, authorizeSubscriber, isLoggedIn } from '../middlewares/getUser.middleware.js';
...
router.route('/:id')
            .get( isLoggedIn, getLetcureByCourseId , authorizeSubscriber)
